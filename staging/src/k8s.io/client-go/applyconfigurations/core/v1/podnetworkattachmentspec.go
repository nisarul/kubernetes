...
// WithParametersRefs sets the ParametersRefs field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ParametersRefs field is set to the value of the last call.
func (b *PodNetworkAttachmentSpecApplyConfiguration) WithParametersRefs(value *ParametersRefApplyConfiguration) *PodNetworkAttachmentSpecApplyConfiguration {
	b.ParametersRefs = value
	return b
}
